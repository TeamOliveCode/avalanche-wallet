<template>
    <div class="content">
        ...
        <p style="padding-top: 12pt; padding-left: 5pt; text-indent: 0pt; text-align: justify">
            ...
            personally or on behalf of an entity (“you”) and GeeBlock (BVI) Inc. (&quot;
            <b>Company</b>
            &quot;, “
            <b>we</b>
            ”, “
            ...
            <span class="s1">https://wallet.gee.network/</span>
            website and related features and services, including but not limited to the GEE wallet
        ...
        <p style="padding-top: 12pt; padding-left: 5pt; text-indent: 0pt; text-align: justify">
            ...
            <a href="mailto:support@gee.network" class="a" target="_blank">support@gee.network</a>
        ...
        <p style="text-indent: 0pt; text-align: left"><br /></p>
        <p style="padding-left: 5pt; text-indent: 0pt; text-align: left">GeeBlock (BVI) Inc.</p>
        <p style="padding-left: 5pt; text-indent: 0pt; text-align: left">
            ...
            <br />
            <a href="mailto:support@gee.network" target="_blank">support@gee.network</a>
        </p>
    </div>
</template>
<script lang="ts">
